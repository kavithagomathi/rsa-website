...
<a  style="width:300px;"href="papersubmit.php">Paper Submission</a> 

<a href="checkid.php">Check Submission</a> 
...
<h2 align="center"> Paper Submission</h2>
...
if(document.getElementById("designation").value =="")
 ...
 if(document.getElementById("select1").value =="")
   ...
   if(document.getElementById("file").value ==".gif")
   {
    alert('Please upload only .pdf and .docx file !!');
    document.getElementById("file").focus();
    return false;
   }
  }
...
function validate_fileupload(input_element)
{
    ...
    var file = input_element.value;
    var allowed_extensions = new Array("docx","pdf");
...
<body>
    <div class="wrapper" style="width:690px;"  >
            ...
            <form action="papersubmit.php" method="post" name="myform" enctype="multipart/form-data">
		
              
                <div class="form-field">
                    <input type="text"  name="subid" value="<?php echo $temp ; ?>"readonly="readonly" />
                </div>
           
		 <div class="form-row">
             
			 <div class="form-label"></div>
                <select id="select" name="suffix">
				
<option value="">Choose an suffix</option>
...
<option value="Prof">Prof</option>
		...
		<div class="form-row">
			...
			<div class="form-row">
			 ...
			 <div class="form-label"></div>
                <div class="form-field">
                    <input type="text" name="uni" id="uni" placeholder="Institution/University" />
            ...
            <div class="form-row">
             <div class="form-label"></div>
                <div class="form-field">
                    <input type="text" name="article" id="article" placeholder="Article Title" />
               </div>
			   
			   <div class="form-row">
             <div class="form-label"></div>
                <select id="select1" name="atype">
				
<option value="">Choose an article</option>
<option value="Research papers">Research papers</option>
<option value="Survey papers">Survey papers</option>
<option value="Review papers">Review papers</option>
<option value="Comparative studies">Comparative studies</option>
<option value=">Case studies">Case studies</option>
<option value="Thesis/ Dissertation chapters">Thesis/ Dissertation chapters</option>
			   ...
			   <div class="form-row">
				 ...
				 <div class="form-label"></div>
                <div class="form-field">
                    <input type="text" name="author" id="author" placeholder="Corresponding Author" />
				 ...
				 <div class="form-label">Accepted Only .PDF/.Docx</div>
               
                  
	 <input type="file" name="file" accept=".pdf,.docx" onchange="validate_fileupload(this);"/>
            ...
            <div class="form-row">
                ...
                <div class="form-field">
                    ...
                    <input type="submit" name="submit"id="submit" value="Submit" onclick="return valid_form();" onChange="document.getElementById('file').value=trim(this.value);"/> 
                </div>
            </div>
		 </form>
...
<tr>	
<th style="text-align: left;">Time taken  for <br>decision(Accept/Reject/Revision)</th>
...
<li>Payment Gateway(PayPal-UPI-QR)</li> 
